    ...
    <section className="section-padding bg-secondary/20" id="about">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-xl text-primary font-medium">A Polymath's Journey</p>
        </div>
        ...
        <div className="space-y-6 text-lg text-muted-foreground">
          ...
          <div className="my-8">
            <h3 className="text-xl font-semibold mb-4 text-center">Areas of Expertise</h3>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {polymathQualities.map((quality, index) => (
                <motion.div
                  ...
                  className="bg-background/50 backdrop-blur-sm p-4 rounded-lg border border-primary/20 text-center shadow-sm hover:shadow-md transition-shadow"
                >
                  {quality}
                </motion.div>
              ))}
